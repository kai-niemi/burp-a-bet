...
import io.burpabet.common.annotations.TransactionPriority;
...
public class TransactionDecoratorAspect {
    ...
    @Around(value = "io.burpabet.common.aspect.Pointcuts.anyTransactionBoundaryOperation(transactionBoundary)",
